...
export { FaRegCopy } from "@react-icons/all-files/fa/FaRegCopy";
export { FaRegClipboard } from "@react-icons/all-files/fa/FaRegClipboard";

export { AiOutlineMail } from "@react-icons/all-files/ai/AiOutlineMail";

export { IoLogoYoutube } from "@react-icons/all-files/io/IoLogoYoutube"; // Youtube

export { GoIssueClosed } from "@react-icons/all-files/go/GoIssueClosed"; // Youtube
export { AiOutlineCloudServer } from "@react-icons/all-files/ai/AiOutlineCloudServer"; // Youtube

export { RiCustomerService2Fill } from "@react-icons/all-files/ri/RiCustomerService2Fill"; // Youtube

/*============== 
    Setup Start use icons 
    =======================================
    NEXT 13 . jS 
================ */

export { GiComputing } from "@react-icons/all-files/gi/GiComputing"; // binery codes
export { MdComputer } from "@react-icons/all-files/md/MdComputer"; // distop
export { AiOutlineMobile } from "@react-icons/all-files/ai/AiOutlineMobile"; // mobile
export { BiMenuAltRight } from "@react-icons/all-files/bi/BiMenuAltRight"; // mobile
